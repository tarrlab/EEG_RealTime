...
recent_epochs_obj = biosemi_fieldtrip_recent_epochs(rt_client, n_recent_event = 40,
                                                event_types = [100, 200])
...
import pickle
pickle.dump(recent_epochs, open('C:\ExperimentData\YingYang\Real_time\checkerboard_realtime_test_20170228_epochs.pickle', 'w'))
